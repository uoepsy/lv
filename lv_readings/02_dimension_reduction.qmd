...
We might visualise these in a 3-dimensional space in @fig-scat.   
...
Think a little about what these dimensions (the axes in @fig-ellip) *represent* - they capture "the ways in which observations vary" across a set of observed variables. 
